...
NOTE: This tutorial is outdated. Please refer to
...
Create an IFTTT applet for our first command.  We will create an Alexa applet.
 Amazon Alexa Controlled Robot

2.  Select “Say a Specific Phrase”.

 applet-say-a-specific-phrase
...
Amazon Alexa Controlled Robot Select That in IFTT
